package com.pvelychko.iterations;
...
public final class BinaryGap {
    ...
    public static void main(String[] args) {
        ...
        Assert.check(binaryGap.solution(9) == 2);
        Assert.check(binaryGap.solution(529) == 4);
        Assert.check(binaryGap.solution(20) == 1);
        Assert.check(binaryGap.solution(15) == 0);
    }
